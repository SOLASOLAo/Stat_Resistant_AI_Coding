...
设备复用与版本入口：[Burster 驱动 / Kistler 集成包](components/README.md)。
当前为独立版本的源码候选包；不等于已生成或部署正式 PLC 安装库。
当前工位候选直接使用 **station010-set-20260911-rc.4**，先看[简短使用说明](components/station010/START-HERE.md)；哈希/清单留作内部记录，无需作为日常接入步骤。
