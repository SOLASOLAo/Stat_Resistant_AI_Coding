...
namespace ForceTrace.Hmi
{
    ...
    {
        public readonly uint Acquisition, Count, WindowMs, TimeoutMs, FirstStableSample, FirstStableMs, ElapsedMs, FirstMs, LastMs, NominalSampleMs;
        public readonly TracePosition Position;
